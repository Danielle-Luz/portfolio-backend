...
var newTechnologySchema = import_zod.z.object({
  name: import_zod.z.string().max(40),
  stack: import_zod.z.enum(stacks),
  knowledgeLevel: import_zod.z.enum(knowledgeLevels).optional().default("Iniciante" /* BEGINNER */),
  iconUrl: import_zod.z.string().url()
});
var updatedTechnologySchema = newTechnologySchema.partial();
var readTechnologySchema = newTechnologySchema.extend({
  id: import_zod.z.number(),
  projects: import_zod.z.array(readProjectSchema)
});

// src/schemas/projects/index.ts
var import_zod2 = require("zod");
var stacks2 = Object.values(Stack);
var newProjectSchema = import_zod2.z.object({
  name: import_zod2.z.string().max(20),
  description: import_zod2.z.string(),
  stack: import_zod2.z.enum(stacks2),
  coverImage: import_zod2.z.string().url(),
  url: import_zod2.z.string().url(),
  highlight: import_zod2.z.boolean().optional().default(false)
});
var updatedProjectSchema = newProjectSchema.partial();
var readProjectSchema = newProjectSchema.extend({
  id: import_zod2.z.number(),
  technologies: import_zod2.z.array(readTechnologySchema)
});

// src/schemas/developmentExperiences/index.ts
var import_zod3 = require("zod");
var experiencesType = Object.values(ExperienceType);
var newDevelopmentExperienceSchema = import_zod3.z.object({
  name: import_zod3.z.string().max(50),
  type: import_zod3.z.enum(experiencesType),
  company: import_zod3.z.string().max(50).optional().default("Empresa n\xE3o informada"),
  description: import_zod3.z.string(),
  startDate: import_zod3.z.string().datetime().optional(),
  endDate: import_zod3.z.string().datetime().optional()
});
