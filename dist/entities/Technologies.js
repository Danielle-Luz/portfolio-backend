...
__decorateClass([
  (0, import_typeorm.Column)({ length: 20, unique: true })
...
__decorateClass([
  (0, import_typeorm.Column)({ nullable: true, default: false })
], Projects.prototype, "highlight", 2);
__decorateClass([
  (0, import_typeorm.ManyToMany)(() => Technologies, (technology) => technology.projects),
